...
void opcontrol() {
	...
	while (true) {
		...
		RopoDevice::LF.SetAimStatus(0.4, atan2(YInput,XInput));
		...
		//MasterController.print(0,0,"%.2f, %.2f", RopoDevice::Motors::LFMotor.get_position(), RopoDevice::Motors::LFMotor_.get_position());
		pros::lcd::print(0,"%.2f",RopoDevice::LF.x);
		pros::delay(20);
	}
}