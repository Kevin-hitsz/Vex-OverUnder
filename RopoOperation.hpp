...
//	//start--导己方四球
	...
	RopoDevice::Chassis.AutoPositionMove(-1.75,1.80,10000,4000);//-1.88 1.66//-1.74 1.90//-1.84 1.88//-1.66
...
//	//中间吃球+推球
	...
	RopoDevice::Chassis.AutoPositionMove(-1.48,0.40,10000,4500);//定位有点问题//y 0.20//0.05 //正中心位
	RopoDevice::gpsAddPosition.SetUpdateFlag(1);
	...
	pros::delay(800);
	ControllerModule::ChangeIntakerPneumatic0();//收
	RopoDevice::Chassis.MoveVelocity(1.0,0);//顶
	pros::delay(530);
	RopoDevice::Chassis.MoveVelocity(-1.0,0);
	pros::delay(700);
	RopoDevice::Chassis.MoveVelocity(0.0,0);
	pros::delay(100); 
	//碰提升杆
	RopoDevice::Chassis.AutoRotateAbs(-165);
	pros::delay(800); 
	RopoDevice::Chassis.MoveVelocity(-1.0,0);
	pros::delay(380); 
	// ControllerModule::ChangeLift();
