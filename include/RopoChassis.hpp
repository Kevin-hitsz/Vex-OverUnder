...
namespace RopoChassis{
	...
	class TankChassis{
		private:
			...
			static constexpr float AccelerationVelocityLimits = 1.4;
			//控制器参数为p，i，d，最大值限幅，最小值限幅，误差容限，到达退出时间（秒）
			inline static RopoControl::PIDRegulator DistanceRegulator{0.0040 ,0.0002  ,0.00006 ,0.0016,-0.0016,0.02,0.15};
