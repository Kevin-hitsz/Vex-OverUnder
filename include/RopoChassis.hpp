...
namespace RopoChassis{
	...
	class TankChassis{
		private:
			...
			static constexpr float AccelerationVelocityLimits = 1.1;
			//控制器参数为p，i，d，最大值限幅，最小值限幅，误差容限，到达退出时间（秒）
			inline static RopoControl::PIDRegulator DistanceRegulator{0.0026 ,0.0006  ,0.00003 ,0.0014,-0.0014,0.02,0.3};
