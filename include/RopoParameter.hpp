...
namespace RopoParameter {
	...
	static constexpr double FIELD_HEADING_INITIAL = 0;//比赛场地相对于战队场地，逆时针为+		(红0，蓝180)
	static constexpr double ROPO_HEADING_INITIAL  = 270 - FIELD_HEADING_INITIAL;//对于战队场地X轴
