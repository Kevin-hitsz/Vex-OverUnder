...
namespace RopoParameter {
	...
	static constexpr double ROPO_HEADING_INITIAL  = 180 - FIELD_HEADING_INITIAL; //资格赛
	...
	static constexpr double GPSX_INITIAL_0 = -0.6 - 0.150; //资格赛
	...
	static constexpr double GPS_HEADING_INITIAL_0 = 90; // 资格赛
