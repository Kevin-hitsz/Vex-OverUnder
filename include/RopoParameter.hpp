...
namespace RopoParameter {
	...
	// 资格赛gps参数
	// static constexpr double FIELD_HEADING_INITIAL = 270;//比赛场地相对于战队场地，逆时针为+		(校内场地红方出发为0)
	...
	// 淘汰赛gps参数
	static constexpr double FIELD_HEADING_INITIAL = 90;//比赛场地相对于战队场地，逆时针为+		(校内场地红方出发为0)
