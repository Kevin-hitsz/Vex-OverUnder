    ...
    class DiffySwerve{
        ...
        public:
            ...
            inline void Initialize(){ // Intialization
                ...
                /*M2 = (2000.0 / 8437) * M2;
                K[1][1] = -14.1412; K[1][2] = 0.4139 ; K[1][3] = 0.0508;        //旧参数
                K[2][1] = K[1][1] ; K[2][2] = K[1][2]; K[2][3] = -K[1][3];*/

                /*M2 = (8.0 / 33.0) * M2;
                K[1][1] = -22.3607; K[1][2] = 0.4877 ; K[1][3] = 0.5164;    //上赛季参数
                K[2][1] = K[1][1] ; K[2][2] = K[1][2]; K[2][3] = -K[1][3];*/

                M2 = 0.3954 * M2;
                K[1][1] = -6.1237; K[1][2] = 0.1182 ; K[1][3] = -0.1637;    //新参数 世锦赛时使用
                K[2][1] = K[1][1] ; K[2][2] = K[1][2]; K[2][3] = -K[1][3];


                //  2024/05/26  新参数                    角度响应更快但会有轻微振荡_测试调整中(需要适配新的闭环移动kp和kd)
                /*M2 = 0.29655 * M2;
                K[1][1] = -12.1268; K[1][2] = 0.1839 ; K[1][3] = -0.3216;
                K[2][1] = K[1][1] ; K[2][2] = K[1][2]; K[2][3] = -K[1][3];*/



                /*M2 = 0.3954 * M2;    
                K[1][1] = -22.3607; K[1][2] = 0.5302 ; K[1][3] = -1.2344;   //新参数1 不可用
                K[2][1] = K[1][1] ; K[2][2] = K[1][2]; K[2][3] = -K[1][3];*/

                /*M2 = 0.3954 * M2;
                K[1][1] = -11.1803; K[1][2] = 0.2978 ; K[1][3] = -0.7905;   // 新参数2
                K[2][1] = K[1][1] ; K[2][2] = K[1][2]; K[2][3] = -K[1][3];*/

                /*M2 = 0.3954 * M2;
                K[1][1] = - 7.9057; K[1][2] = 0.1938 ; K[1][3] = -0.4885;   //新参数3
                K[2][1] = K[1][1] ; K[2][2] = K[1][2]; K[2][3] = -K[1][3];*/
